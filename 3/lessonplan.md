...
- We've covered a lot of new concepts this unit. We will start this unit with a brief conceptual review of the topics and tools we covered in the previous class, then work on a review activity.
...
#### Next Week's Azure Lab Environment

- Students will be using the new NetSec Azure lab environment for the next unit. Please find the registration link in the Azure credentials spreadsheet.
...
- At the end of today's class:
  ...
  - Explain that the machines are found in this environment and share the log-in credentials for each ones.
...
### 00. Everybody Do: Hyper-V Upgrade (for Azure users only)

Before beginning the lesson today, we are going give our Linux machines a little bit more processing power for an activity that we will be preforming later today.

Make sure all students using Azure complete the following steps:

1. Navigate to your Ubuntu settings.
2. Click on `Processor`.
3. For `Number of virtual processors`, type **4** then click **Apply**.

![](images/hyper-v.png)


Verify that students have added the additional processors before moving onto the first section of the day.
...
### 02. Student Do: Cryptography Refresher (0:10)
...
The goal of this activity was to practice using digital signatures with GPG, and to illustrate digital signatures can be used to send messages that are guaranteed to be authentic.

Completing this activity required the following steps:

  - Writing a new message using the command line.

  - Clearsigning the message using GPG.

  - Transferring the clearsigned message to a partner.

  - Receiving a partner's clearsigned message and verifying its authenticity with GPG.
...
This solution is an example, as each student will have a different key and message. The following example demonstrates how to sign and verify a message with GPG.
...
- Send this message to your partner.
...
### 05. Student Do: Steganography Activity (0:07)
...
- [Image of the Car](images/mydreamcar.jpg)
...
- [Solution Guide: Steganography ](activities/steganography/solved/readme.md)
...
### 07. Instructor Do: SSL Certificates (0:12)
...
### 12. Student Do: Cryptographic Attacks Activity  (0:15)
...
### 14. Instructor Do: Introduction to Rainbow Tables and Hashcat (0:07)
...
### 15. Student Do: Hashcat Activity (0:10)
